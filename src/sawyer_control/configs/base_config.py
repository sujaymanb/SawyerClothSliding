...
RESET_SAFETY_BOX_LOWS = np.array([-.22, -0.58, 0.13])
RESET_SAFETY_BOX_HIGHS = np.array([.86, 0.51, 0.52])
...
#right front corner: [0.84431, -0.5652, 0.1387]
#left front corner: [-0.22636, -0.5806, 0.1317]
#right back corner: [0.86611199 0.50420731 0.11108213]
#left back corner: [-0.25390896 0.l.60966206 0.13736157]
# z max 0.51289