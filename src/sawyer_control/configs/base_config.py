...
RESET_SAFETY_BOX_LOWS = np.array([-.22, -0.58, 0.02])
...
POSITION_SAFETY_BOX_LOWS = np.array([0.16, -0.41, 0.02])
POSITION_SAFETY_BOX_HIGHS = np.array([.84, .56, .52])
...
RESET_ERROR_THRESHOLD = .00*np.ones(7)
UPDATE_HZ = 30
